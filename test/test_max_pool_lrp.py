    ...
    def runTest(self):
        ...
        with g.as_default():
            ...
            with tf.Session() as sess:
                ...
                prediction, explanation = sess.run([pred, expl], feed_dict={inp: [[1 ,2 ],[3 ,4 ],[5 ,6 ],[-1 , -2],[-3 ,-4 ],[10 ,0 ]]
})
                ...
                self.assertTrue(
                    np.allclose(explanation[0], [[0 ,0 ],[0 , 8],[0 ,12 ],[0 , 0],[0 ,0 ],[10 ,0 ]], rtol=1e-03, atol=1e-03),
