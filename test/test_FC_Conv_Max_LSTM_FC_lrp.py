    ...
    def runTest(self):
        ...
        with tf.Graph().as_default():
            ...
            with tf.Session() as s:
                ...
                expected_result = np.array([[0.0, 0.003141549784, 0.0008113131025, 0.0, 0.0, 0.0],
                                            [0.0, 0.004065012004, 0.001049799534, 0.0, 0.0, 0.0],
                                            [0.002117792284, 0.001602829493, 0.00662006448, 0.001515988088,
                                             0.03139723368, 0.02084404859],
                                            [-0.001881286127, -0.00142383222, -0.005880763452, -0.001346688898,
                                             -0.02789092234, -0.01851627269],
                                            [0.01815769713, 0.01615478065, 0.001067970707, 4.045956959e-06,
                                             0.005966971829, 0.0678268776],
                                            [-0.0004607792373, -0.0004099521793, -2.710138429e-05, -1.02672324e-07,
                                             -0.000151421004,
                                             -0.001721210389],
                                            [-0.0001319432865, -0.0002162578856, -0.003486719319, -0.0001022488413, 0.0,
                                             -7.79149157e-05],
                                            [-0.0006244537355, -0.001023493109, -0.0165017483, -0.0004839175422, 0.0,
                                             -0.0003687513132]]).reshape((4, 2, 6))
